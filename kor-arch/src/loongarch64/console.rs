//! `Console` implementation for loongarch64 — NS16550A over MMIO.
//!
//! The QEMU `virt` console UART sits at `0x1FE0_01E0`; this installs a
...
pub static CONSOLE: Ns16550aMmio = Ns16550aMmio { base: 0x1FE0_01E0 };
